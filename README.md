...
[![My Skills](https://skillicons.dev/icons?i=js,ts,react,nextjs,nodejs,angular,express,nestjs,vue,php,laravel,html,css,tailwind,bootstrap,mysql,mongodb,postgres,c,cpp,py,cs,dotnet,django,go,rust,wordpress,postman,bitbucket,github,git,gcp,aws,docker,kubernetes,scss&theme=light)](https://skillicons.dev)
